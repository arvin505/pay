...
import com.miqtech.master.client.core.alipay.utils.SignUtils;
...
public class AliPay extends Pay {
    ...
    @Override
    public void pay(String outTradeNum, String shopName, String body, String price) {
        if (shopName == null || body == null || price == null)
            throw new IllegalStateException("params wrong, alipay need shopname & body & price");
        String orderInfo = getOrderInfo(shopName, body, price, outTradeNum);
